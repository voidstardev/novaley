...
if game.CoreGui:FindFirstChild("Library") then
 ...
 function VLib:Window(text, textgame, textcircle)
  ...
  function Tabs:Tab(text)
     ...
     --UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(236, 207, 160)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 212, 102))}
...
local win = VLib:Window("Novaley Hub", "2.0 Beta | Ingyenes", Color3.fromRGB(252, 83, 83))
       local fomenu = win:Tab("Fő menű")
          fomenu:line()
          fomenu:Label("Hírek")
          fomenu:Label("+ Beta 1.0")
          fomenu:Label("+ Prémium rendszer")
          fomenu:Label("+ Új Szkriptek checkold le a Szkriptek kategóriában!")
          fomenu:line()
          fomenu:Label("Szkriptek")
          fomenu:Button("Raise a Floppa 2",function()
             loadstring(game:HttpGet("https://raw.githubusercontent.com/voidstardev/vehicle-speed/main/raiseafloppa2/script.lua"))()
          end)
          fomenu:Button("Infinite Yield",function()
             loadstring(game:HttpGet("https://cdn.wearedevs.net/scripts/Infinite%20Yield.txt"))()
          end)
          fomenu:Button("Evade",function()
             loadstring(game:HttpGet("https://raw.githubusercontent.com/voidstardev/vehicle-speed/main/evade/script.lua"))()
          end)
          --fomenu:Button("???",function()
             --loadstring(game:HttpGet(""))()
          --end)
          fomenu:line()
       local PremiumOnly = win:Tab("Premium", "http://www.roblox.com/asset/?id=6023426915")
       PremiumOnly:line()
       PremiumOnly:Label("Nincs prémiumod!")
       PremiumOnly:line()
       local Players = win:Tab("Játékosok", "http://www.roblox.com/asset/?id=6023426915")
       local SelectedPly = Players:Label("Játékos Kiválasztva: Nincs")
       PlayerName = {}
       for i,v in pairs(game.Players:GetChildren()) do  
          table.insert(PlayerName ,v.Name)
       end
       KillPlayer = ""
       local Player = Players:Dropdown("Játékos Kiválasztva",PlayerName,function(plys) --true/false, replaces the current title "Dropdown" with the option that t
          KillPlayer = plys
          SelectedPly:Refresh(plys)
       end)
       
       Players:Button("Játékos frissités",function()
          PlayerName = {}
          Player:Clear()
          for i,v in pairs(game.Players:GetChildren()) do  
             Player:Add(v.Name)
       ...
       Players:Toggle("Játékos megfigyelése",false,function(bool)
          Sp = bool
       ...
       Players:Button("Játékos Teleportálás",function()
          local plr1 = game.Players.LocalPlayer.Character
          local plr2 = game.Players:FindFirstChild(KillPlayer)
          plr1.HumanoidRootPart.CFrame = plr2.Character.HumanoidRootPart.CFrame
       end)
       local Misc = win:Tab("Egyéb", "http://www.roblox.com/asset/?id=6023426915")
       Misc:Label("Szerver Idő")
       Time = Misc:Label("Szerver Idő")
       local function UpdateTime()
       local GameTime = math.floor(workspace.DistributedGameTime+0.5)
       local Hour = math.floor(GameTime/(60^2))%24
       local Minute = math.floor(GameTime/(60^1))%60
       local Second = math.floor(GameTime/(60^0))%60
       Time:Refresh("Óra: "..Hour.." Perc: "..Minute.." Másodperc: "..Second)
       end
       spawn(function()
             while true do
                UpdateTime()
       ...
       Misc:Toggle("Automatikus Klikkelés",false,function(value)
          AuctoClick = value
       end)
       Fly = false    
      ...
      Misc:Toggle("Repülés",false,function(Value)
         Fly = Value
         activatefly()
      end)
       Misc:Button("FPS Gyorsitás",function()
       ...
       local Setting = win:Tab("Beállitások", "http://www.roblox.com/asset/?id=6023426915")
       Setting:Label("Developer - peaxch_dev#8423")
       Setting:Label("Developer - OnlyMilan#8407")
       Setting:Button("Újracsatlakozás",function()
      ...
      Setting:Button("Szerver Váltás",function()
     ...
     Setting:line()
     Setting:Button("Discord Link másolás",function()
        setclipboard("https://discord.gg/qt3pJkhxnq")
     end)
     Setting:Button("UI szétbontás",function()
        Library:Destroy()
     end)
